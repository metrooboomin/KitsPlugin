...
public class KitArrays {
    ...
    public static List<String> switcherUsed = new ArrayList<String>();
    public static List<String> snailUsed = new ArrayList<String>();
    public static List<String> matrixUsed = new ArrayList<String>();

    //COOLDOWNS
    public static List<String> pikaWAIT = new ArrayList<String>();
    public static List<String> ghostWAIT = new ArrayList<String>();
    public static List<String> matrixWAIT = new ArrayList<String>();
